...
const MainSection = () => {
  return (
    <div className="flex flex-col items-center justify-center sm:justify-start min-h-screen py-2 bg-orange-100 pt-0 ">
      <div className="w-full max-w-md mx-auto text-center min-h-3/4">
        ...
        <Link href="/register" legacyBehavior>
          <a className="mt-6 px-4 py-2 bg-orange-500 rounded text-white hover:bg-orange-600 w-full sm:w-auto">IR A/CREAR PERFIL</a>
        </Link>
      </div>
